...
import com.rdkl.common.domain.question.KnowledgePoint;
import com.rdkl.common.domain.question.PointStatistic;
import com.rdkl.common.domain.question.Question;
import com.rdkl.common.domain.question.QuestionContent;
import com.rdkl.common.domain.question.QuestionFilter;
import com.rdkl.common.domain.question.QuestionQueryResult;
import com.rdkl.common.domain.question.QuestionStatistic;
import com.rdkl.common.domain.question.QuestionStruts;
import com.rdkl.common.domain.question.QuestionTag;
import com.rdkl.common.domain.question.QuestionType;
import com.rdkl.common.domain.question.Tag;
import com.rdkl.common.util.Page;
import com.rdkl.common.util.StringUtil;
import com.rdkl.common.util.file.ExcelUtil;
import com.rdkl.management.persistence.QuestionMapper;
	...
	public void uploadQuestions(String filePath, String username, int fieldId) {
		...
		try {
			...
			for (Map<String, String> map : questionMapList) {
				...
				question.setName(StringUtil.escape(map.get("题目")));
