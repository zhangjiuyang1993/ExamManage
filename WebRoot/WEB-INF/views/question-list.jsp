						...
						<div class="page-content">
							...
							<div id="question-list">
								...
								<table class="table-striped table">
									<thead>
										<tr>
											<!-- <td></td> --><td style="width:60px">ID</td><td class="question-name-td">试题名称</td><td  style="width:90px;">类型</td><td  style="width:90px;">创建人</td><td style="width:100px;">创建时间</td><td style="width:90px;">操作</td>
										</tr>
									</thead>
									<tbody>
										...
										<c:forEach items="${questionList }" var="items">
											<tr>
												...
												<td>
													<a href="<%=list[1]%>/question/question-preview/${items.id }" target="rightContent" title="${items.name }">${fn:substring(items.name,0,50) }</a>
														<div class="question-tags">
														<c:if test="${items.tags != null}">
															<span>标签：${items.tags }&nbsp;</span>
														</c:if>
														<c:if test="${items.fieldName != null}">
															<span>专业：${items.fieldName }&nbsp;</span>
														</c:if>
															<span>知识分类：${items.pointName }</span>
															<!-- <span>易错题</span>
															<span>送分题</span> -->
														</div>
												...
												<td>${items.creator }</td> <td><fmt:formatDate value="${items.create_time}"
											...
											<div class="modal-body">
												<form id="question-edit-form">
													...
													<div class="form-line form-question-analysis" style="display: block;">
														...
														<textarea class="add-question-ta" style="width: 100%;" id="question-answer"></textarea><span class="form-message"></span>
														<br>
													</div>
						...
						success : function(message, tst, jqXHR) {
							...
							if (message.result == "success") {
								...
								$.each(message.object.knowledgePoint, function(index, element){
								 ...
								 UE.getEditor('question-answer').setContent(message.object.analysis);
