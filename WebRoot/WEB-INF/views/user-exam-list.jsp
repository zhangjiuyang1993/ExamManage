											...
											<tr>
												...
												<td>
													...
													<c:if test="${item.approved == 2 }">
														<a target="rightContent" href="<%=list[1]%>/exam/mark-exampaper/${item.histId}">阅卷</a>
													</c:if>
													<c:if test="${item.approved == 3 }">
														<a target="rightContent" href="<%=list[1]%>/exam/mark-exampaper/${item.histId}">重复阅卷</a>
													</c:if>
												</td>
												...
												<td>
													...
													<c:if test="${item.approved == 3 }">
														<a target="rightContent" href="<%=list[1]%>/exam/student-answer-sheet/${item.histId}">查看答卷</a>
													</c:if>
												</td>
											</tr>
										</c:forEach>
