						...
						<div class="page-content">
							...
							<div id="question-list">
								...
								<table class="table-striped table">
									<thead>
										<tr>
											<td></td><td style="width:60px">ID</td><td class="question-name-td">试题名称</td><td  style="width:90px;">试题类型</td><td  style="width:90px;">创建人</td>
										</tr>
									</thead>
									<tbody>
										...
										<c:forEach items="${questionList }" var="items">
											<tr>
												...
												<td>
													<a href="<%=list[1]%>/question/question-preview/${items.id }" target="_blank" title="${items.name }">${fn:substring(items.name,0,35) }</a>
